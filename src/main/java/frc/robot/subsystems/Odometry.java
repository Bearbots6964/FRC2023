...
public class Odometry extends SubsystemBase {
   ...
   * @param kinematics Distance between the tracks as a {@link edu.wpi.first.math.kinematics.DifferentialDriveKinematics} object.
   * @param wheelSpeeds The speed of the left and right wheels, as a {@link edu.wpi.first.math.kinematics.DifferentialDriveWheelSpeeds} object.
   * @return The chassis speed of the robot.
   **/
  public ChassisSpeeds getChassisSpeeds(DifferentialDriveKinematics kinematics, DifferentialDriveWheelSpeeds wheelSpeeds) {
    return kinematics.toChassisSpeeds(wheelSpeeds);
  }

  /**
   * Returns the linear velocity given chassis speeds.
   * @param chassisSpeeds The speed of the chassis as a {@link edu.wpi.first.math.kinematics.ChassisSpeeds} object. 
   ...
   * @param rotation The angle of the gyroscope as a {@link edu.wpi.first.math.geometry.Rotation2d} object.
   ...
   */
  public DifferentialDriveOdometry getOdometry(Rotation2d rotation, double leftDistance, double rightDistance, Pose2d pose2d) {
